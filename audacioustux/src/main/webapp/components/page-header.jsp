...
<nav class="sticky top-4 bottom-4">
      ...
      <div class="flex-1 flex items-center justify-center sm:items-stretch sm:justify-start">
        ...
        <div class="hidden sm:block sm:ml-6">
          <div class="flex space-x-4 rounded-md p-1 bg-pink-100 bg-opacity-80 backdrop-filter backdrop-blur">
            ...
            <a href="#" class="text-gray-700 hover:bg-gray-700 hover:text-white px-3 py-2 rounded-md text-sm font-medium">Blogs</a>
        ...
        <div class="ml-3 relative">
          <div>
            ...
            >
              ...
              <img class="h-8 w-8 rounded-full" src="https://raw.githubusercontent.com/audacioustux/paste/master/7238675.jpg" alt="" />
            </button>
          </div>
